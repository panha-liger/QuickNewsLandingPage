    ...
    return (
        order === 1 ? (
            <div className="flex items-center justify-between my-20 lg:flex-row flex-col">
                ...
                <div className="relative group max-w-sm sm:max-w-md  rounded-[60px] hover:scale-[1.03] hover:rotate-2  transition-all duration-500 p-14">
                    <video
                        src={src}
                        autoPlay
                        muted
                        ...
                        playsInline
                        preload="metadata"
                        className="w-full h-full object-contain rounded-[60px]"
                    />
                </div>
            </div>
        ) : (

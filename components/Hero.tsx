      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12 sm:py-16 lg:py-20">
        <div className="text-center mb-12 sm:mb-16 lg:mb-20">
          <div className="flex flex-wrap items-center justify-center gap-2 sm:gap-3 mb-6 sm:mb-8">
            <Badge className="px-3 py-1.5 sm:px-4 sm:py-2 text-xs sm:text-sm font-medium shadow-lg">AI Chat</Badge>
            <Badge variant="secondary" className="px-3 py-1.5 sm:px-4 sm:py-2 text-xs sm:text-sm font-medium shadow-lg">Verified Creators</Badge>
            <Badge variant="green" className="px-3 py-1.5 sm:px-4 sm:py-2 text-xs sm:text-sm font-medium shadow-lg">Real News</Badge>
          </div>
          
          <h1 className="font-newsreader text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold text-text tracking-tight mb-6 sm:mb-8">
            The Future of
            <br />
          ...
          <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-muted-foreground max-w-2xl sm:max-w-3xl mx-auto mb-8 sm:mb-12 px-4">
            <strong className="text-text">Creators earn 10X more than TikTok</strong> sharing real news.
            <br className="hidden sm:block" />
            <strong className="text-text">GenZ creators welcome!</strong> Write articles + provide sources.
          </p>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-12 sm:mb-16 lg:mb-20">
            <div className="text-center mb-8 sm:mb-12 px-4">
              <h3 className="font-newsreader text-2xl sm:text-3xl font-bold text-text mb-3 sm:mb-4">Desktop Experience</h3>
              <p className="text-base sm:text-lg text-muted-foreground">Full-featured news dashboard with AI chat</p>
            </div>
          ...
          <div>
            <div className="text-center mb-8 sm:mb-12 px-4">
              <h3 className="font-newsreader text-2xl sm:text-3xl font-bold text-text mb-3 sm:mb-4">Mobile App</h3>
              <p className="text-base sm:text-lg text-muted-foreground">Quick news videos with AI verification</p>
            </div>
